...
inline void Benchmarking::CurrentDriveBenchmark()
{
	...
	if (WriteBenchmarkFile())
	{
		...
		{
			fileManager->ReadDataFile(BENCHMARK__FILE_NAME, readBuffer, BENCHMARK__FILE_READ_SIZE,
		...
		fileManager->DeleteDataFile(BENCHMARK__FILE_NAME);
	}
